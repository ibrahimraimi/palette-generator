...
<button
	{...$trigger}
	use:trigger
	class="group relative w-full rounded-md border shadow-sm outline-none ring-black/5 transition-all focus-visible:ring-4"
>
	<div
		class="mb-2 flex items-center justify-between gap-1 border-b p-1 text-[10px] tabular-nums opacity-50"
	>
	...
	<div
		class={cn(
			"absolute inset-0 z-40 flex items-center justify-center bg-black/5 opacity-0 transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100",
			$open && "opacity-100"
		)}
	>
